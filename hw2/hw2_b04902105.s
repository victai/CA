...
# NOTE : Before you submit the code, make sure these two fields are "input.txt" and "output.txt"
	file_in:
		.asciiz	"/home/victai/Desktop/input.txt"
	file_out:
		.asciiz	"/home/victai/Desktop/output.txt"
...
beq $t4, $t5, addition
beq $t4, $t6, subtraction
beq $t4, $t7, multiplication
beq $t4, $t8, division
...
itoa:
	...
	mfhi 	$s5
	addi 	$s5, $s5 '0'
	sb		$s5, output_ascii+3

	div 	$a0, $t0
	mflo	$a0
	mfhi 	$s5
	addi 	$s5, $s5 '0'
	sb		$s5, output_ascii+2
	...
	mfhi 	$s5
	addi 	$s5, $s5 '0'
	sb		$s5, output_ascii+1

	div 	$a0, $t0
	mflo	$a0
	mfhi 	$s5
	addi 	$s5, $s5 '0'
	sb		$s5, output_ascii+0
